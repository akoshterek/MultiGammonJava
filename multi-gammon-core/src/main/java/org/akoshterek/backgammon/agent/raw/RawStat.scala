...
object RawStat {
  ...
  val stat: Vector[RawStat] = Vector[RawStat](
    ...
    RawStat("Raw-Sutton-40-softplus", 748, 0.009840643, 429, 0.016803679, 649, 0.01214572),
    RawStat("Raw-Tesauro89-40-softplus", 363, 0.008089913, 682, 0.016031522, 430, 0.008397575),
    RawStat("Raw-Tesauro92-40-softplus", 520, 0.015131258, 458, 0.016562982, 330, 0.021340616),
    RawStat("Raw-Gnubg-40-softplus", 462, 0.007234208, 605, 0.022361723, 275, 0.014354779),
